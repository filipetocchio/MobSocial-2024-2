/*
  ...
  - Added the required column `telefone` to the `TbUsuarioVoluntario` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_TbUsuarioVoluntario" ("areasInteresse", "closedAt", "cpf", "createdAt", "email", "excludedAt", "experiencia", "id", "openedat", "password", "refreshToken", "updatedAt", "username") SELECT "areasInteresse", "closedAt", "cpf", "createdAt", "email", "excludedAt", "experiencia", "id", "openedat", "password", "refreshToken", "updatedAt", "username" FROM "TbUsuarioVoluntario";
