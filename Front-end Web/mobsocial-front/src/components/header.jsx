  ...
  return (
    <div className='text-[#A3A3A3] border-2 h-72 bg-black flex flex-col md:flex-row items-center justify-around p-4'>
        ...
        <div className='flex flex-col md:flex-row gap-4 w-full md:w-[20%] h-auto mt-4 md:mt-0'>
            ...
            <Link to="/cadastro" className='bg-[#1E1E1E] hover:scale-105 hover:brightness-200 p-4 rounded-lg border-[#F5FDFF] border-2 w-full md:w-[100%] flex justify-center'>
                <h1 className='text-xl md:text-3xl'>Cadastrar</h1>
            </Link>
        </div>
    </div>
  )
